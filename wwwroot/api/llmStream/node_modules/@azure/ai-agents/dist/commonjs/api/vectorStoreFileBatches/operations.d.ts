...
import type { _AgentsPagedResultVectorStoreFile, VectorStoreFileBatch, VectorStoreFile } from "../../models/models.js";
...
import type { StreamableMethod, PathUncheckedResponse } from "../../../../../../@azure-rest/core-client/dist/esm/index.js";
import type { OperationState, PollerLike } from "../../../../../core-lro/dist/esm/index.js";
...
export declare function listVectorStoreFileBatchFiles(context: Client, vectorStoreId: string, batchId: string, options?: VectorStoreFileBatchesListVectorStoreFileBatchFilesOptionalParams): PagedAsyncIterableIterator<VectorStoreFile>;
