...
export declare function _createOrUpdateSend(context: Client, name: string, version: string, index: IndexUnion, options?: IndexesCreateOrUpdateOptionalParams): StreamableMethod;
export declare function _createOrUpdateDeserialize(result: PathUncheckedResponse): Promise<IndexUnion>;
/** Create a new or update an existing Index with the given version id */
export declare function createOrUpdate(context: Client, name: string, version: string, index: IndexUnion, options?: IndexesCreateOrUpdateOptionalParams): Promise<IndexUnion>;
