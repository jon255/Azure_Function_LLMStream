import type { HttpClient, LogPolicyOptions, Pipeline, PipelineOptions, PipelinePolicy, PipelineRequest, PipelineResponse, RawHttpHeaders, RequestBodyType, TransferProgressEvent } from "../../../../@azure/core-rest-pipeline/dist/esm";
import type { RawHttpHeadersInput } from "../../../../@azure/core-rest-pipeline/dist/esm";
import type { AbortSignalLike } from "../../../../@azure/abort-controller/dist/esm";
import type { OperationTracingOptions } from "../../../../@azure/core-tracing/dist/esm";
/**
